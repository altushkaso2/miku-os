...
impl Ext2Fs {
    pub fn alloc_block(&mut self, preferred_group: usize) -> Result<u32, Ext2Error> {
    ...
    pub fn alloc_inode(&mut self, preferred_group: usize) -> Result<u32, Ext2Error> {
        let gc = self.group_count as usize;
    ...
    fn update_group_free_blocks(&mut self, group: usize, delta: i16) -> Result<(), Ext2Error> {
        if group >= 32 {
            return Err(Ext2Error::InvalidBlock);
        }
    ...
    fn update_group_free_inodes(&mut self, group: usize, delta: i16) -> Result<(), Ext2Error> {
        if group >= 32 {
            return Err(Ext2Error::InvalidInode);
        }
    ...
    fn update_superblock_free_blocks(&mut self, delta: i32) -> Result<(), Ext2Error> {
    ...
    fn update_superblock_free_inodes(&mut self, delta: i32) -> Result<(), Ext2Error> {
